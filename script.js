...
let tickIcon= '<div class="icon tick"><span>&#10004</span></div>';
let crossIcon= '<div class="icon cross"><span>&#10006</span></div>';
...
function queCounter(index){
    const bottom_ques_counter = quiz_box.querySelector(".totalques");
